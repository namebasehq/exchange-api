...
class Exchange {
  ...
  supplyTicker(asset) {
    const endpoint = '/ticker/supply';
    return this._request('GET', endpoint, { asset });
  }
  ...
  marketSell(symbol, quantity, receiveWindow) {
    return this._createOrder(
      symbol,
      enums.OrderSides.SELL,
  ...
  marketBuy(symbol, quantity, receiveWindow) {
    return this._createOrder(
      symbol,
      enums.OrderSides.BUY,
      enums.OrderTypes.MKT,
  ...
  userTrades(symbol, tradeId, limit, receiveWindow) {
    const endpoint = '/trade/account';
    return this._timedRequest('GET', endpoint, { symbol, tradeId, limit, receiveWindow });
  }

  orderTrades(symbol, orderId, receiveWindow) {
